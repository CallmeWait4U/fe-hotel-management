...
const ServiceCard = (props: { serviceName: string, title: string, introduction: string, imgUrl: string, isImgLeft: boolean }) => {
  return (
    // If medium device
    <div className="md:flex max-w-5xl px-4 w-full mx-auto transition-transform duration-300 hover:scale-105 pt-3">
      ...
      <div className="flex flex-col justify-between bg-light-1 p-4">
        ...
        <Link className="flex" href={`/services/${props.serviceName.replace(" ", "-").toLowerCase()}`}>
          <button
